...
#ifndef __MX6QIVENIXM5_COMMON_CONFIG_H
#define __MX6QIVENIXM5_COMMON_CONFIG_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mtddevname=u-boot\0" \
	"mtddevnum=0\0" \
	"mtdparts=mtdparts=gpmi-nand:2m(u-boot),128k(env1),128k(env2),150m(linux1)," \
	"150m(linux2),-(user)\0" \
	"partition=nand0,0\0" \
	"netifc=wlan0\0" \
	...
	"bootenv_nand=setenv bootargs ${bootargs} ${mtdparts} root=ubi0:rootfs rootfstype=ubifs" \
	" rootflags=no_chk_data_crc ubi.mtd=linux${bootsel}\0" \
...
#endif                         /* __MX6QIVENIXM5_COMMON_CONFIG_H */
